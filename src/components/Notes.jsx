  ...
  const pencilPng = (
    <svg width="16" height="16" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      3.93916 13.7324 4.10414 13.4025 4.43398L13.4018 4.43468L11.0091 6.82736M7.67272 3.49106L11.0091 6.82736"
       stroke="#6C63FF" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
                ...
                <div className='todo-text-div'>
                  ...
                  style={{
                    backgroundColor: isChecked
                      ? (checkedIndex === noteIndex ? '#6C63FF' : '')
                      : 'white',
                  }}
                  onClick={()=>{handleCheck(noteIndex)}}
                  >
                    {isChecked?
                    (checkedIndex === noteIndex ? 
                      <i className="fa-solid fa-check"></i> : "" ):(
                      null)}
                  </button>
                  <div className={isChecked ? (checkedIndex === noteIndex ?'checked-font' : "") : ''}> {note} </div>
                </div>
